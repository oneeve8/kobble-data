...
2. I was able to cut and paste the items into the folder, so I did that for each item. Everything seemed to go okay. They wereThen when I expanded and contracted the folder, each time it opened again, it had replaced an item

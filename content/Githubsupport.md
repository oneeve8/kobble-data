...
You will need a GitHub account in order for Kobble to enable sharing. Just tap the Home button and select the GitHub tab, so you can set up either a private or free public GitHub account.

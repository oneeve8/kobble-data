...
To insert a video in Markdown, use the @ symbol before the title in brackets, followed by the video id embed code in parenthesis, like this: @[youtube] (video id)

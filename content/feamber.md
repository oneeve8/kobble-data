...
I realised through my temporary obsession, that a puzzle is a good metaphor for solving problems. A puzzle is easier to do if you find all the edges first. Then you put all the pieces into piles by Color and then by shape. Fitting the pieces together, and then seeing the whole picture
